...
const NetAssetTag: FC<TagProps> = ({ assetsum }) => {
  ...
  return (
    <div className="flex max-w-fit flex-col items-center gap-2 rounded-xl bg-lightBlue px-4 py-2.5">
      <div className="flex text-lg font-medium">{'net asset sum'}</div>
      <div className="flex text-[28px] font-medium text-cobalt">
        {modSum}
        {letter}
      </div>
    </div>
