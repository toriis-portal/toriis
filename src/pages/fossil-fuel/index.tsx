...
export const getServerSideProps = async () => {
  ...
  const FossilFuelEntries = await contentClient.getFossilFuelPageLinks("link", "FossilFuelPage")
...
const FossilFuelPage: FC<FossilFuelProps> = ({ caseEntries, ListEntries, FossilFuelEntries, LinkEntries}) => {
  console.log("hi")
